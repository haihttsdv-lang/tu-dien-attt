...
export const contentBlocksT2PlNew: ContentBlock[] = [
  {
    ...
    kind: "dien_giai",
    body:
      "Luật An toàn thông tin mạng (số 86/2015/QH13, thông qua 19/11/2015, hiệu lực 01/07/2016) là văn bản cấp luật đầu tiên và nền tảng của Việt Nam chuyên về an toàn thông tin mạng theo nghĩa kỹ thuật — khác với Luật An ninh mạng (2018, xem PL-02) vốn nghiêng về khía cạnh an ninh quốc gia/trật tự xã hội trên không gian mạng. Luật gồm các nhóm nội dung chính: bảo đảm an toàn thông tin mạng (trách nhiệm quản lý, bảo vệ thông tin cá nhân, bảo vệ hệ thống thông tin), mật mã dân sự, tiêu chuẩn/quy chuẩn kỹ thuật an toàn thông tin mạng, kinh doanh trong lĩnh vực an toàn thông tin mạng, và phát triển nguồn nhân lực.\n\n**Vị trí trong hệ thống văn bản:** Luật 86/2015 đóng vai trò luật khung, được cụ thể hóa bởi nhiều nghị định và thông tư hướng dẫn — trong đó Nghị định 85/2016/NĐ-CP về bảo đảm an toàn hệ thống thông tin theo cấp độ (xem PL-05) là nghị định hướng dẫn quan trọng nhất đối với hoạt động của tổ chức, và ngành ngân hàng còn có thêm lớp quy định chuyên ngành riêng (Thông tư 09/2020/TT-NHNN, Thông tư 50/2024/TT-NHNN — xem PL-07, PL-08).\n\n**CẢNH BÁO QUAN TRỌNG VỀ TÌNH TRẠNG HIỆU LỰC:** trong quá trình tra cứu xây dựng kho tri thức này, có dấu hiệu (qua mô tả gián tiếp trên vbpl.vn) cho thấy Luật 86/2015 hiện không còn hiệu lực toàn văn — tức có thể đã ở trạng thái hiệu lực một phần tương tự ca ví dụ kinh điển của Thông tư 09/2020 (xem PL-07 và ca kiểm thử bắt buộc của module hiệu lực). Tuy nhiên, KHÔNG xác minh được cụ thể điều khoản nào đã bị bãi bỏ/sửa đổi hay bởi văn bản nào trong phiên tra cứu này. Đây là lỗ hổng tri thức quan trọng: một luật nền được viện dẫn rộng rãi trong ngành mà tình trạng hiệu lực chính xác chưa được xác nhận đầy đủ. Trước khi trích dẫn bất kỳ điều khoản cụ thể nào của Luật 86/2015 trong hồ sơ chính thức, bắt buộc phải mở trực tiếp trang lược đồ (thuộc tính văn bản) của Luật này trên vbpl.vn để xem đầy đủ lịch sử sửa đổi/bãi bỏ.\n\n**Liên hệ với Luật Bảo vệ dữ liệu cá nhân 2025:** một phần nội dung về bảo vệ thông tin cá nhân trong Luật 86/2015 (Mục 2 Chương II theo cấu trúc luật, liên quan tới trách nhiệm bảo vệ thông tin cá nhân trên mạng) có khả năng cao đã được bao phủ lại hoặc điều chỉnh bởi Luật Bảo vệ dữ liệu cá nhân số 91/2025/QH15 mới có hiệu lực từ 01/01/2026 (xem PL-04) — đây là một giả thuyết hợp lý về nguyên nhân 'hiệu lực một phần' nêu trên, nhưng KHÔNG được coi là đã xác nhận cho tới khi đối chiếu trực tiếp văn bản.",
    sources: [
  ...
  },
  {
    ...
    kind: "dien_giai",
    body:
      "Luật An ninh mạng (số 24/2018/QH14, thông qua 12/6/2018 với hơn 86% đại biểu tán thành, hiệu lực 01/01/2019) điều chỉnh hoạt động bảo vệ an ninh quốc gia và bảo đảm trật tự, an toàn xã hội trên không gian mạng — phạm vi điều chỉnh khác biệt rõ rệt so với Luật An toàn thông tin mạng (2015, xem PL-01): Luật An ninh mạng đặt trọng tâm vào phòng ngừa, phát hiện, ngăn chặn, xử lý hành vi xâm phạm an ninh quốc gia/trật tự xã hội trên không gian mạng (thông tin chống Nhà nước, khủng bố mạng, gián điệp mạng, tội phạm mạng...), trong khi Luật An toàn thông tin mạng thiên về khía cạnh kỹ thuật bảo vệ hệ thống và dữ liệu nói chung. Hai luật vận hành song song, bổ trợ lẫn nhau chứ không thay thế nhau — một tổ chức cần tuân thủ đồng thời cả hai.\n\n**Văn bản hướng dẫn quan trọng nhất:** Nghị định 53/2022/NĐ-CP (15/8/2022, hiệu lực 01/10/2022) quy định chi tiết một số điều của Luật An ninh mạng — đây là nguồn trực tiếp cho yêu cầu lưu trữ dữ liệu trong nước (xem PL-03), một trong những nội dung được doanh nghiệp công nghệ, đặc biệt doanh nghiệp nước ngoài cung cấp dịch vụ tại Việt Nam, quan tâm nhiều nhất khi luật được ban hành.\n\n**Trách nhiệm của doanh nghiệp cung cấp dịch vụ trên không gian mạng:** Luật quy định trách nhiệm phối hợp với cơ quan chức năng trong phòng ngừa, xử lý hành vi vi phạm an ninh mạng, bao gồm khả năng phải cung cấp thông tin người dùng khi có yêu cầu hợp pháp từ cơ quan có thẩm quyền theo trình tự pháp luật quy định, và trách nhiệm xóa bỏ, ngăn chặn thông tin vi phạm khi được yêu cầu. Đây là nhóm nghĩa vụ khác về bản chất so với các yêu cầu kỹ thuật thuần túy (mã hóa, kiểm soát truy cập) trong Luật An toàn thông tin mạng — đòi hỏi tổ chức có quy trình pháp chế/tuân thủ xử lý riêng, không chỉ đơn thuần là vấn đề của bộ phận kỹ thuật.\n\n**Với ngành ngân hàng:** hệ thống ngân hàng lõi và hạ tầng thanh toán quốc gia có khả năng được xem xét là một phần của hệ thống thông tin quan trọng về an ninh quốc gia theo tiêu chí của Luật (dù kho tri thức này chưa xác minh danh mục cụ thể các hệ thống ngân hàng nào chính thức được xếp vào nhóm này) — nếu thuộc diện đó, tổ chức phải tuân thủ thêm các yêu cầu thẩm định an ninh mạng bổ sung so với hệ thống thông thường.",
    sources: [
      { type: "legal_document", refId: "luat-24-2018-qh14" },
  ...
  },
  {
    ...
    kind: "dien_giai",
    body:
      "Quyết định 2345/QĐ-NHNN (ban hành 18/12/2023, hiệu lực 01/07/2024) yêu cầu triển khai các giải pháp an toàn, bảo mật trong thanh toán trực tuyến và thanh toán thẻ ngân hàng — văn bản này gắn liền với một trong những thay đổi được truyền thông rộng rãi nhất trong ngành ngân hàng bán lẻ Việt Nam gần đây: yêu cầu xác thực sinh trắc học cho giao dịch chuyển tiền trực tuyến vượt một ngưỡng giá trị nhất định.\n\n**Vì sao đây là văn bản HÀNH CHÍNH CÁ BIỆT, không phải văn bản quy phạm pháp luật:** khác với Luật, Nghị định, Thông tư (văn bản quy phạm pháp luật, áp dụng chung, công bố trên Công báo Chính phủ theo quy trình chính thức), một 'Quyết định' của NHNN dạng này thường là văn bản áp dụng riêng cho hoạt động quản lý điều hành của ngành, không nhất thiết trải qua quy trình công bố/lấy ý kiến rộng rãi như luật/nghị định. Điều này có hai hệ quả thực tiễn: (1) văn bản dạng này có thể được sửa đổi nhanh hơn, ít 'tiếng vang truyền thông' hơn so với lần ban hành đầu — rủi ro một ngưỡng đã lỗi thời vẫn được lưu truyền trong tài liệu nội bộ; (2) việc tra cứu văn bản gốc đầy đủ khó khăn hơn so với luật/nghị định vì không phải lúc nào cũng có sẵn công khai đầy đủ trên các nguồn tổng hợp phổ biến.\n\n**Ngưỡng được nhiều nguồn tham khảo nhắc lại nhất quán (CẦN XÁC MINH LẠI TRƯỚC KHI ÁP DỤNG CHÍNH THỨC):** giao dịch chuyển tiền qua tài khoản trực tuyến hoặc nạp tiền vào ví điện tử có giá trị trên 10 triệu đồng cần xác thực sinh trắc học (khuôn mặt hoặc vân tay); nếu dưới 10 triệu đồng và tổng giá trị các giao dịch chuyển tiền trong ngày không vượt quá 20 triệu đồng thì có thể chỉ cần xác thực bằng mã OTP (gửi qua SMS, giọng nói, hoặc email). Đây CHÍNH LÀ loại thông tin mà URD của dự án này liệt kê là rủi ro cao nhất nếu trích dẫn sai — một con số ngưỡng bị nhớ nhầm hoặc đã lỗi thời có thể dẫn tới tư vấn sai cho khách hàng/đơn vị nghiệp vụ về việc giao dịch nào cần xác thực sinh trắc học.\n\n**Khuyến nghị sử dụng:** dùng các con số trên như ĐIỂM KHỞI ĐẦU để tra cứu, không phải căn cứ cuối cùng cho bất kỳ hồ sơ kiểm tra, tư vấn khách hàng, hay quyết định thiết kế hệ thống nào — luôn đối chiếu lại với văn bản gốc hoặc thông báo chính thức mới nhất từ NHNN/ngân hàng đang áp dụng trước khi sử dụng con số cụ thể trong công việc chính thức.",
